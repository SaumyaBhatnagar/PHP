...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null,$Dirname) {
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => $Dirname.'/',//dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            'upload_url' => $this->get_full_url().'/'.$Dirname.'/',//'/files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
